...
<?php
function ambilPeminjaman($con, $id_pinjam){
...
<?php
function ambilStok($con, $id_buku){
...
<?php
function updateStok($con, $id_buku, $stok_update){
...
?>
<?php
function hitungDenda($con, $id_pinjam, $tgl_kembali){
	$denda=0;
